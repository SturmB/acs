...
namespace Illuminate\Support\Facades {
    ...
    class App
    {
        ...
        public static function registerDeferredProvider(
            $provider,
            $service = null
        ) {
            /** @var \Illuminate\Foundation\Application $instance */
        ...
        public static function addContextualBinding(
            $concrete,
            $abstract,
            $implementation
        ) {
    ...
    class Cookie
    {
        ...
        public static function setDefaultPathAndDomain(
            $path,
            $domain,
            $secure = false,
            $sameSite = null
    ...
    class DB
    {
        ...
        public static function selectFromWriteConnection(
            $query,
            $bindings = array()
        ) {
            //Method inherited from \Illuminate\Database\Connection
        ...
        {
            //Method inherited from \Illuminate\Database\Connection
            \Larapack\DoctrineSupport\Connections\MySqlConnection::resolverFor(
                $driver,
                $callback
            );
        }
        ...
        {
            //Method inherited from \Illuminate\Database\Connection
            return \Larapack\DoctrineSupport\Connections\MySqlConnection::getResolver(
                $driver
            );
        }
    ...
    class Notification
    {
        ...
        public static function assertSentTo(
            $notifiable,
            $notification,
            $callback = null
        ) {
        ...
        public static function assertSentToTimes(
            $notifiable,
            $notification,
            $times = 1
        ) {
    ...
    class Queue
    {
        ...
        public static function assertPushedWithChain(
            $job,
            $expectedChain = array(),
            $callback = null
        ) {
    ...
    class Response
    {
        ...
        public static function redirectGuest(
            $path,
            $status = 302,
            $headers = array(),
            $secure = null
    ...
    class Storage
    {
        ...
        public static function getAwsTemporaryUrl(
            $adapter,
            $path,
            $expiration,
            $options
            ...
            /** @var \Illuminate\Filesystem\FilesystemAdapter $instance */
            return $instance->getAwsTemporaryUrl(
                $adapter,
                $path,
                $expiration,
                $options
        ...
        public static function getRackspaceTemporaryUrl(
            $adapter,
            $path,
            $expiration,
            $options
            ...
            /** @var \Illuminate\Filesystem\FilesystemAdapter $instance */
            return $instance->getRackspaceTemporaryUrl(
                $adapter,
                $path,
                $expiration,
                $options
    ...
    class Validator
    {
        ...
        public static function extendImplicit(
            $rule,
            $extension,
            $message = null
        ) {
        ...
        public static function extendDependent(
            $rule,
            $extension,
            $message = null
        ) {
    ...
    class View
    {
        ...
        public static function renderWhen(
            $condition,
            $view,
            $data = array(),
            $mergeData = array()
        ...
        public static function renderEach(
            $view,
            $data,
            $iterator,
            $empty = 'raw|'
...
namespace TCG\Voyager\Facades {
    ...
    class Voyager
    {
        ...
        public static function afterFormFields(
            $row,
            $dataType,
            $dataTypeContent
        ) {
            /** @var \TCG\Voyager\Voyager $instance */
            return $instance->afterFormFields(
                $row,
                $dataType,
                $dataTypeContent
            );
...
namespace  {
    ...
    class Eloquent extends \Illuminate\Database\Eloquent\Model
    {
        ...
        public static function orWhereHas(
            $relation,
            $callback = null,
            $operator = '>=',
            $count = 1
        ...
        public static function joinWhere(
            $table,
            $first,
            $operator,
            $second,
        ...
        public static function rightJoinWhere(
            $table,
            $first,
            $operator,
            $second
        ...
        public static function prepareValueAndOperator(
            $value,
            $operator,
            $useDefault = false
        ) {
        ...
        public static function orWhereColumn(
            $first,
            $operator = null,
            $second = null
        ) {
        ...
        public static function whereIntegerInRaw(
            $column,
            $values,
            $boolean = 'and',
            $not = false
        ...
        public static function whereIntegerNotInRaw(
            $column,
            $values,
            $boolean = 'and'
        ) {
        ...
        public static function whereNotBetween(
            $column,
            $values,
            $boolean = 'and'
        ) {
        ...
        public static function whereDate(
            $column,
            $operator,
            $value = null,
            $boolean = 'and'
        ...
        public static function addWhereExistsQuery(
            $query,
            $boolean = 'and',
            $not = false
        ) {
        ...
        public static function whereRowValues(
            $columns,
            $operator,
            $values,
            $boolean = 'and'
        ...
        public static function whereJsonContains(
            $column,
            $value,
            $boolean = 'and',
            $not = false
        ...
        public static function whereJsonDoesntContain(
            $column,
            $value,
            $boolean = 'and'
        ) {
        ...
        public static function whereJsonLength(
            $column,
            $operator,
            $value = null,
            $boolean = 'and'
        ...
        public static function orHaving(
            $column,
            $operator = null,
            $value = null
        ) {
        ...
        public static function havingRaw(
            $sql,
            $bindings = array(),
            $boolean = 'and'
        ) {
        ...
        public static function forPageBeforeId(
            $perPage = 15,
            $lastId = 0,
            $column = 'id'
        ) {
        ...
        public static function forPageAfterId(
            $perPage = 15,
            $lastId = 0,
            $column = 'id'
        ) {
