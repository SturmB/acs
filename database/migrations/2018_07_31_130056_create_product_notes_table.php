    ...
    public function up()
    {
        Schema::create($this->tableName, function (Blueprint $table) {
            ...
            $table
                ->string('title', 250)
                ->nullable()
                ->comment('The title of the note. Preferably only 1–5 words. HTML is allowed.');
            $table
                ->text('body')
                ->comment(
                    'The body of the note tht will be displayed on the web page, with HTML structuring.'
                );
            $table
