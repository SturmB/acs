    ...
    <div id="general-content" class="p-3">
        ...
        <div class="row clipart__info m-2 m-md-4">
            ...
            <div class="col-12 clipart__intro">
                <img src="{{ asset('images/clipart/clipart-sketch-' . $clipartSubcategory->clipartCategory->id . '.svg') }}" alt="Sample Sketch"
                ...
                <div class="clipart__instructions">
                    @if($clipartSubcategory->clipartCategory->id === 'aircraft')
                        <img src="{{ asset('images/clipart/clipart-combination-sample.svg') }}" alt="Plane On Clouds"
                ...
                @if(count($images) > 0)
                    @foreach($images as $image)
                        ...
                        <div class="clipart__thumb col-12 col-sm-6 col-md-3 col-xl-2">
                            <figure class="img-thumbnail position-relative mb-1" style="background: #fff url('{{ asset('images/clipart/' . $clipartSubcategory->id . '/' . $image) }}') center center no-repeat; -webkit-background-size: 95% 95%; background-size: 95% 95%;">
                                {{--<img src="{{ asset('images/clipart/' . $clipartSubcategory->id . '/' . $image) }}" alt="{{ $filename }}" class="thumbnail__img position-absolute">--}}
                            </figure>
